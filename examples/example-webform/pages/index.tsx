    ...
    <div className="container px-6 pb-10 mx-auto">
      ...
      <div className="container max-w-2xl px-6 py-10 mx-auto">
        <article className="prose lg:prose-xl">
          ...
          <p>
            This example uses the <a href="https://www.drupal.org/project/next_webform">
            Next.js Webform
          </a>{" "} library to render and submit forms built
            using the Drupal Webform module.
          </p>
        </article>
        <Webform id={id} data={webform}
          // className="space-y-6"
                 customComponents={{
                   ...
                   webform_actions: withCustomStyles(components.webform_actions, {className: classNames('bg-sky-500 hover:bg-sky-700 text-white font-bold py-2 px-4 rounded my-4')}),
